    ...
    public class CarrinhoCompraController : ControllerBase
    {
        ...
        public async Task<ActionResult<CarrinhoItemDto>> GetItem(int id)
        {
            try
            {
                ...
                var produto = await this._produtoRepository.GetItem(carrinhoItem.ProdutoId);
        ...
        [HttpPost]
        public async Task<ActionResult<CarrinhoItemDto>> PostItem(CarrinhoItemAdicionaDto carrinhoItemAdicionaDto)
        {
            try
            {
